...
begin
   ...
   if ACBrETQ.Modelo in [etqPpla, etqPplb] then
    ...
    begin
      ACBrETQ.ImprimirTexto(orNormal, '0', 60, 60, 3, 3, edtLinha1.Text, 0, True);
      ACBrETQ.ImprimirTexto(orNormal, 'A', 100, 100, 18, 32, edtLinha2.Text);
      ACBrETQ.ImprimirTexto(orNormal, 'A', 120, 120, 15, 50, edtLinha2.Text);
       ACBrETQ.ImprimirBarras(orNormal, barEAN13, 2, 2, 13, 5, edtLinha4.Text, 10, becSIM);
    end;
   ACBrETQ.Desativar;
end;
